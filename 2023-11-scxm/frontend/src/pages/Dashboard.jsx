...
import { FileDoneOutlined, InboxOutlined, InfoCircleOutlined, TeamOutlined, ToolOutlined } from "@ant-design/icons";
...
const Dashboard = () => {
  ...
  return (
    <Container size="lg">
      ...
      <StyledPopover
        content={
          <div style={{ maxWidth: 300, textAlign: "justify" }}>
            Mọi thống kê hiện tại được tính theo 30 ngày gần nhất. Chúng tôi sẽ cập nhật thêm các bộ lọc chi tiết hơn
            trong tương lai
          </div>
        }
        title="Lưu ý"
      ...
      <Row gutter={[18, 18]} className="mt-4">
        <Col span={24}>
          <Card title="Tổng quan kinh doanh" bordered={false}>
            <Row gutter={18}>
              <Col xs={8} lg={5}>
